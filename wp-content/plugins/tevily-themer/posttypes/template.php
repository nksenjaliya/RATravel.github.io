...
class Gavias_Themer_Template{
	...
	public function args_post_type_template(){
		$labels = array(
			'name'               => esc_html__( 'Template', 'tevily-themer' ),
			'singular_name'      => esc_html__( 'Template', 'tevily-themer' ),
			'add_new'            => esc_html__( 'Add Template', 'tevily-themer' ),
			'add_new_item'       => esc_html__( 'Add Template', 'tevily-themer' ),
			'edit_item'          => esc_html__( 'Edit Template', 'tevily-themer' ),
			'new_item'           => esc_html__( 'New Template', 'tevily-themer' ),
			'view_item'          => esc_html__( 'View Template', 'tevily-themer' ),
			'search_items'       => esc_html__( 'Search Template Profiles', 'tevily-themer' ),
			'not_found'          => esc_html__( 'No Template Profiles found', 'tevily-themer' ),
			'not_found_in_trash' => esc_html__( 'No Template Profiles found in Trash', 'tevily-themer' ),
			'parent_item_colon'  => esc_html__( 'Parent Template:', 'tevily-themer' ),
			'menu_name'          => esc_html__( 'Templates & Layout', 'tevily-themer' ),
		);
