<div class="gva-template-wrapper">
   ...
   <div class="gva-template-content">
      ...
      <div id="gva-ajax-loadding" class="ajax-message" style="opacity: 0;">
         <div class="content">
            <img src="<?php echo GAVIAS_TEVILY_PLUGIN_URL ?>/layout/assets/loading.gif"/>
         </div>  
      </div>

      <div id="gva-ajax-success" class="ajax-message" style="opacity: 0;">
         <div class="content-inner" style="text-align: center;">
            <img src="<?php echo GAVIAS_TEVILY_PLUGIN_URL ?>/layout/assets/animated-check.gif"/>
            <h2><?php echo esc_html__('Changes saved successfully', 'tevily-themer') ?></h2>
         </div>  
      </div>
