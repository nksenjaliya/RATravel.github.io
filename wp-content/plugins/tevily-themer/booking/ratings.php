...
class Tevily_Booking_Review{
   ...
   public function ratings_criteria() {
      $rating['quality'] = esc_html__('Quality', 'tevily-themer');
      $rating['location'] = esc_html__('Location', 'tevily-themer');
      $rating['amenities'] = esc_html__('Amenities', 'tevily-themer');
      $rating['services'] = esc_html__('Services', 'tevily-themer');
      $rating['price'] = esc_html__('Price', 'tevily-themer');
      return apply_filters('tevily_booking_criteria', $rating);
   }
   ...
   public function settings_rating_criteria() {
      add_settings_field(
         'criteria_arr',
         __( 'Rating Criteria List', 'tevily-themer' ),
...
return new Tevily_Booking_Review();
