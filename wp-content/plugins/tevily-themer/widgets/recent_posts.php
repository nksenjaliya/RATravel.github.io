...
class Tevily_Themer_Widget_Recent_Posts extends WP_Widget {
   ...
   */
   ...
   public function widget( $args, $instance ) {
      ...
      $default_title = esc_html__( 'Recent Posts', 'tevily-themer' );
            ...
            <li>
               <div class="clearfix post-list-item <?php echo (has_post_thumbnail($recent_post->ID) ? 'has-thumbnail' : 'no-thumbnail' )  ?>">
                  ...
                  <div class="post-content">
                     <?php
                        $comments_number = get_comments_number_text( esc_html__('0 Comments', 'tevily-themer'), esc_html__('1 Comment', 'tevily-themer'), esc_html__('% Comments', 'tevily-themer'), $recent_post->ID);
                        printf( 
...
function tevily_themer_widget_recent_posts(){
   return register_widget('Tevily_Themer_Widget_Recent_Posts');
}

add_action('widgets_init', 'tevily_themer_widget_recent_posts');
