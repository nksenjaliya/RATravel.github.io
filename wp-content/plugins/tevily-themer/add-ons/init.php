...
class Gavias_Addon_Form_Ajax{
	...
	public function __construct(){
		...
		add_action('tevily/addons/user', array($this, 'html_form'));
		$this->include_files();
	}
	...
	public function register_scripts(){
		wp_register_script('ajax-form', GAVIAS_TEVILY_PLUGIN_URL . 'assets/js/ajax-form.js', array('jquery') ); 
		wp_enqueue_script('ajax-form');
		
		wp_localize_script( 'ajax-form', 'form_ajax_object', array( 
		  'ajaxurl' => admin_url( 'admin-ajax.php' ),
		  'redirecturl' => home_url(),
		  'security_nonce' => wp_create_nonce( "tevily-ajax-security-nonce" )
		));
	}
