...
class GVAElement_Rev_Slider extends \Elementor\Widget_Shortcode{
    ...
    public function get_title() {
        return __('GVA Revolution Slider', 'tevily-themer');
    }
    ...
    protected function register_controls() {
        ...
        if ( $arrSliders ) {
            ...
            $revsliders[ __( 'No sliders found', 'tevily-themer' ) ] = 0;
        }
        ...
        $this->add_control(
            'alias_slider',
            [
                'label'   => __( 'Choose Slider:', 'tevily-themer' ),
    ...
    protected function render() {
      ...
      printf( '<div class="gva-element-%s gva-element">', $this->get_name() );
        include(GAVIAS_TEVILY_PLUGIN_DIR . 'elementor/views/plugins/rev-slider.php');
      print '</div>';
