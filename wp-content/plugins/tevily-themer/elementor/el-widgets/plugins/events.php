...
class GVAElement_Events extends GVAElement_Base{
	...
	public function get_title() {
		return __('GVA Events', 'tevily-themer');
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'event_start_date' => __( 'Event Start Date', 'tevily-themer' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'event-1'     => __( 'Event Item Style I', 'tevily-themer' )
				],
				'default' => 'event-1',
				'condition' => [
