...
class GVAElement_Post_Name extends GVAElement_Base{
	...
	public function get_title(){
		return esc_html__('Post Title', 'tevily-themer');
	}
	...
	protected function register_controls(){
		$this->start_controls_section(
			self::NAME,
			[
				'label' => esc_html__('General', 'tevily-themer'),
		...
		$this->add_control(
			'html_tag',
			[
				'label' => esc_html__('Tag', 'tevily-themer'),
				'type' => Controls_Manager::SELECT,
				'options' => [
				  	'div' => esc_html__('DIV', 'tevily-themer'),
				  	'h1' => esc_html__('H1', 'tevily-themer'),
				  	'h2' => esc_html__('H2', 'tevily-themer'),
				  	'h3' => esc_html__('H3', 'tevily-themer'),
				  	'h4' => esc_html__('H4', 'tevily-themer'),
				  	'h5' => esc_html__('H5', 'tevily-themer'),
				],
				'default' => 'h1',
			]
		);
