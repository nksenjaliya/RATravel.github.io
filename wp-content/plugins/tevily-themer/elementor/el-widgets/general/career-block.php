...
class GVAElement_Career_Block extends GVAElement_Base {
   ...
   public function get_categories() {
	...
	public function get_title() {
		return __( 'Career Block', 'tevily-themer' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					'url' => GAVIAS_TEVILY_PLUGIN_URL . 'elementor/assets/images/icon.png',
				],
			]
		);
		...
		$this->add_control(
			'job_type',
			[
				'label' => __( 'Job Type', 'tevily-themer' ),
				'type' => Controls_Manager::TEXT,
				'default' => 'Full Time'
			]
		);
		$this->add_control(
			'company',
			[
				'label' => __( 'Company', 'tevily-themer' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->add_control(
			'address',
			[
				'label' => __( 'Address', 'tevily-themer' ),
				'type' => Controls_Manager::TEXT,
		...
		$this->start_controls_section(
			'info_type_style',
			[
				'label' => __( 'Information (Address & Company)', 'tevily-themer' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
