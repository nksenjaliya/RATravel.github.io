...
class GVAElement_Posts extends GVAElement_Base{
    ...
    public function get_title() {
        return __('Posts All Items', 'tevily-themer');
    }
    ...
    private function get_categories_list(){
        ...
        $categories['none'] = __( 'None', 'tevily-themer' );
        $taxonomy = 'category';
    ...
    private function get_posts() {
        ...
        $posts['none'] = __('None', 'tevily-themer');
    ...
    protected function register_controls() {
         ...
         $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'small_list'    => __( 'Small List', 'tevily-themer' ),
                    'sticky'        => __( 'Post Large & List', 'tevily-themer' )
                ]
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'post-style-1'         => __( 'Item Post Style I', 'tevily-themer' ),
                    'post-style-2'         => __( 'Item Post Style II', 'tevily-themer' ),
                ],
                'condition' => [
        ...
        $this->add_control(
            'image_size',
            [
               'label'     => __('Image Style', 'tevily-themer'),
               'type'      => \Elementor\Controls_Manager::SELECT,
        ...
        $this->add_control(
         'excerpt_words',
         [
            'label'     => __('Excerpt Words', 'tevily-themer'),
            'type'      => 'number',
            'default'   => 15
         ]
        );
        ...
        $this->add_control(
            'category_ids',
            [
                'label' => __( 'Select By Category', 'tevily-themer' ),
        ...
        $this->add_control(
            'post_ids',
            [
                'label' => __( 'Select Individually', 'tevily-themer' ),
                'type' => Controls_Manager::SELECT2,
                'default' => '',
                'multiple'    => true,
                'label_block' => true,
        ...
        $this->add_control(
            'posts_per_page',
            [
                'label' => __( 'Posts Per Page', 'tevily-themer' ),
        ...
        $this->add_control(
            'orderby',
            [
                'label'   => __( 'Order By', 'tevily-themer' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'post_date',
                'options' => [
                    'post_date'  => __( 'Date', 'tevily-themer' ),
                    'post_title' => __( 'Title', 'tevily-themer' ),
                    'menu_order' => __( 'Menu Order', 'tevily-themer' ),
                    'rand'       => __( 'Random', 'tevily-themer' ),
                ],
            ]
        );
        ...
        $this->add_control(
            'order',
            [
                'label'   => __( 'Order', 'tevily-themer' ),
                'type'    => Controls_Manager::SELECT,
                'default' => 'desc',
                'options' => [
                    'asc'  => __( 'ASC', 'tevily-themer' ),
                    'desc' => __( 'DESC', 'tevily-themer' ),
                ],
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Right List Posts Style', 'tevily-themer' ),
        ...
        $this->add_responsive_control(
            'stick_list_padding',
            [
                'label' => __( 'Padding List Posts', 'tevily-themer' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Background List Posts', 'tevily-themer' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'List Posts Title Color', 'tevily-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'List Posts Meta Color', 'tevily-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Content', 'tevily-themer' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
        ...
        $this->add_responsive_control(
            'post_box_padding',
            [
                'label' => __( 'Padding Post Content', 'tevily-themer' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
        ...
        $this->add_control(
            'post_box_background',
            [
                'label' => __( 'Background Post Content', 'tevily-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Title', 'tevily-themer' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'layout' => ['grid', 'carousel']
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Color Title', 'tevily-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Color Title Hover', 'tevily-themer' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Post Description', 'tevily-themer' ),
                'tab'   => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'layout' => ['grid', 'carousel']
                ],
