...
class GVAElement_BA_Item_Taxonomy extends GVAElement_Base{
	...
	public function get_title() {
		return __('BA Item Taxonomy', 'tevily-themer');
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default'      => esc_html__('Your Title', 'tevily-themer'),
				'label_block'  => true
			]
		);
		$this->add_control(
			'taxonomy_slug',
			array(
				'label'   => esc_html__('Ba Taxonomies', 'tevily-themer'),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .tevily-single-taxonomy .ba-meta-title' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tevily-single-taxonomy .ba-meta-title',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tevily-single-taxonomy .item-value' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .tevily-single-taxonomy .item-value',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .tevily-single-taxonomy .icon i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .tevily-single-taxonomy .icon svg' => 'fill: {{VALUE}};',
					'{{WRAPPER}} .tevily-single-taxonomy.style-2 .content-inner .box-content .term-item i' => 'color: {{VALUE}};',
					'{{WRAPPER}} .tevily-single-taxonomy.style-2 .content-inner .box-content .term-item svg' => 'fill: {{VALUE}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
				  '{{WRAPPER}} .tevily-single-taxonomy .icon i' => 'font-size: {{SIZE}}{{UNIT}};',
				  '{{WRAPPER}} .tevily-single-taxonomy .icon svg' => 'width: {{SIZE}}{{UNIT}};',
				  '{{WRAPPER}} .tevily-single-taxonomy.style-2 .content-inner .box-content .term-item i' => 'font-size: {{SIZE}}{{UNIT}};',
				  '{{WRAPPER}} .tevily-single-taxonomy.style-2 .content-inner .box-content .term-item svg' => 'width: {{SIZE}}{{UNIT}};'
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
				  '{{WRAPPER}} .tevily-single-taxonomy .icon' => 'padding-right: {{SIZE}}{{UNIT}};',
				  '{{WRAPPER}} .tevily-single-taxonomy.style-2 .content-inner .box-content .term-item i' => 'margin-right: {{SIZE}}{{UNIT}};',
				  '{{WRAPPER}} .tevily-single-taxonomy.style-2 .content-inner .box-content .term-item svg' => 'margin-right: {{SIZE}}{{UNIT}};'
				],
			]
		);
