...
class GVAElement_BA_Item_Max_Guests extends GVAElement_Base{
   ...
   public function get_title() {
      return __('BA Item Max Guests', 'tevily-themer');
   }
   ...
   protected function register_controls() {
      ...
      $this->add_control(
         ...
         [
            ...
            'default'      => esc_html__( 'Max Guests', 'tevily-themer' ),
            'label_block'  => true
         ]
      );
      ...
      $this->add_control(
         ...
         [
            ...
            'selectors' => [
               '{{WRAPPER}} .tevily-single-max_guests .ba-meta-title' => 'color: {{VALUE}};',
            ],
         ]
      );
      ...
      $this->add_group_control(
         ...
         [
            ...
            'selector' => '{{WRAPPER}} .tevily-single-max_guests .ba-meta-title',
         ]
      );
      ...
      $this->add_control(
         ...
         [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
               '{{WRAPPER}} .tevily-single-max_guests .item-value' => 'color: {{VALUE}};',
            ],
         ]
      );
      ...
      $this->add_group_control(
         ...
         [
            ...
            'selector' => '{{WRAPPER}} .tevily-single-max_guests .item-value',
         ]
      );
      ...
      $this->add_control(
         ...
         [
            ...
            'type' => Controls_Manager::COLOR,
            'selectors' => [
               '{{WRAPPER}} .tevily-single-max_guests .icon i' => 'color: {{VALUE}};',
               '{{WRAPPER}} .tevily-single-max_guests .icon svg' => 'fill: {{VALUE}};',
            ],
         ]
      );
      $this->add_responsive_control(
         ...
         [
            ...
            'selectors' => [
              '{{WRAPPER}} .tevily-single-max_guests .icon i' => 'font-size: {{SIZE}}{{UNIT}};',
              '{{WRAPPER}} .tevily-single-max_guests .icon svg' => 'width: {{SIZE}}{{UNIT}};'
            ],
         ]
      );
      ...
      $this->add_responsive_control(
         ...
         [
            ...
            'selectors' => [
              '{{WRAPPER}} .tevily-single-max_guests .icon' => 'padding-right: {{SIZE}}{{UNIT}};',
            ],
         ]
      );
