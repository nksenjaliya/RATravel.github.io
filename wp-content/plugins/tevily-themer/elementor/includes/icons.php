<?php
   add_filter( 'elementor/icons_manager/additional_tabs', 'tevily_custom_icons_filters' , 9999999, 1 );
   function tevily_custom_icons_filters( $tabs = array() ) {
      $newicons = [
         "flaticon-selection",
         "flaticon-delete",
      ...
      $icons['gva_custom_icon'] = array(
           'name'          => 'tevily-icons-theme',
           'label'         => esc_html__( 'Icons Theme', 'tevily-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $newicons,
           'url'          => GAVIAS_TEVILY_PLUGIN_URL . 'assets/icons/flaticon.min.css',
           'ver'           => '1.0',
       );
   ...
   add_action( 'wp_print_footer_scripts', 'tevily_insert_icons_footer_css'  );
   function tevily_insert_icons_footer_css() {
      echo '<link rel="stylesheet" type="text/css" href="' . GAVIAS_TEVILY_PLUGIN_URL . 'assets/icons/flaticon.min.css">';
   }

   add_filter( 'elementor/icons_manager/additional_tabs', 'tevily_lineawesome_icon' );  
   function tevily_lineawesome_icon( $icons = array() ) {
       ...
       $icons['tevily-lineawesome-icon'] = array(
           'name'          => 'tevily-icons-lineawesome',
           'label'         => esc_html__( 'Line Awesome', 'tevily-themer' ),
           'labelIcon'     => 'fas fa-user',
           'prefix'        => '',
           'displayPrefix' => '',
           'icons'         => $lineawesome_icons,
            'url'          => GAVIAS_TEVILY_PLUGIN_URL . 'elementor/assets/libs/line-awesome/css/line-awesome.min.css',
           'ver'           => '1.0',
       );
