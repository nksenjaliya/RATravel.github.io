	...
	<div class="gva-content-items"> 
         ...
         <div <?php echo $this->get_render_attribute_string('grid') ?>>
   			<?php
                  ...
                  echo '<div class="item-columns item-masory">';
      					$this->tevily_get_template_part('templates/content/item', $settings['style'], array(
      ...
      <?php }else{ ?>
         <div class="search-no-results-content">
            <div class="message"><?php echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'tevily-themer' ); ?></div>
            <?php get_search_form() ?>
         </div>
      <?php } ?>   
	</div>
