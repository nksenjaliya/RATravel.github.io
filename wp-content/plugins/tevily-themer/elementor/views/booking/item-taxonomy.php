<?php
   ...
   $terms_value = get_the_terms($tevily_post->ID, 'ba_amenities');

?>

   <div class="tevily-single-taxonomy slug-<?php echo esc_attr($taxonomy_slug) ?> <?php echo esc_attr($settings['style']) ?>">
         ...
         <div class="box-content">
            <?php 
               ...
               if( empty($taxonomy_slug) ){ 
                  ...
                  echo '<div class="item-value">' . esc_html__('N/A', 'tevily-themer') . '</div>';
               }

               if( ($taxonomy_slug == 'amenities' || $taxonomy_slug == 'car-amenities' || $taxonomy_slug == 'car-feautures') && $settings['style'] == 'style-2'){
                  $terms_value = get_the_terms($tevily_post->ID, BABE_Post_types::$attr_tax_pref . $taxonomy_slug);
                  ...
                  $value = get_the_term_list($tevily_post->ID, BABE_Post_types::$attr_tax_pref . $taxonomy_slug, '', ', ');
