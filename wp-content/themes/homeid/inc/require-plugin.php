...
function homeid_require_plugin() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => get_template_directory() . '/inc/plugins/g5-core-v1.6.4.zip', // The plugin source
            'required'           => true, // If false, the plugin is only 'recommended' instead of required
	    ...
	    array(
		    ...
		    'source'             => get_template_directory() . '/inc/plugins/g5-ere-v1.5.3.zip', // The plugin source
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required
	    ...
	    array(
		    ...
		    'source'             => get_template_directory() . '/inc/plugins/homeid-addons-v1.1.2.zip', // The plugin source
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            ...
            'source'             => get_template_directory() . '/inc/plugins/g5-element-v1.2.6.zip', // The plugin source
            'required'           => false, // If false, the plugin is only 'recommended' instead of required
	    ...
	    array(
		    ...
		    'source'             => get_template_directory() . '/inc/plugins/g5-install-demo-v1.1.0.zip', // The plugin source
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required
	    ...
	    array(
		    ...
		    'source'             => get_template_directory() . '/inc/plugins/elementor-pro-3.11.1.zip', // The plugin source
		    'required'           => true, // If false, the plugin is only 'recommended' instead of required
		    'version'            => '3.11.1', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
		    'force_activation'   => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
		    'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
		    'external_url'       => '', // If set, overrides default API URL and points to an external URL
	    ),
