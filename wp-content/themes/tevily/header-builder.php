...
*/ 
	...
	if('publish' == get_post_status($header_id)){
		$document = Plugin::instance()->documents->get($header_id);
	  	$header_position = $document->get_settings('tevily_header_position');
  	}
?>
<!DOCTYPE html>
...
<body <?php body_class() ?>>
  ...
  <div class="tevily-page-loading"></div>
	...
	<div class="wrapper-page"> <!--page-->
		...
		<?php do_action( 'tevily_after_header' );  ?>
