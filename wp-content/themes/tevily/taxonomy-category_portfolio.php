 ...
 */
	...
	$columns_lg = tevily_get_option('portfolio_columns_lg', '4');
	$columns_md = tevily_get_option('portfolio_columns_md', '3');
	$columns_sm = tevily_get_option('portfolio_columns_sm', '2');
	$columns_xs = tevily_get_option('portfolio_columns_xs', '1');
